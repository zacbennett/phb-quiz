export const questions = [
  ...
  },
  {
    ...
    "questions": [
        {
            "question": "An epidural hematoma is most accurately defined as:",
            "answers": {
        ...
        {
            "question": "A 28-year-old male was struck in the chest with a baseball bat during an altercation. He is conscious and alert and complains of severe chest pain. Your assessment reveals a large area of ecchymosis over the sternum and a rapid, irregular pulse. In addition to providing supplemental oxygen, you should:",
            "answers": {
                "A": "determine if he has cardiac problems.",
        ...
        {
            "question": "During your assessment of a patient with blunt chest trauma, you note that the patient has shallow breathing and paradoxical movement of the left chest wall. You should:",
            "answers": {
        ...
        {
            "question": "Following a stab wound to the left anterior chest, a 25-year-old male presents with a decreased level of consciousness and signs of shock. Which of the following additional assessment findings should increase your index of suspicion for a cardiac tamponade?",
            "answers": {
        ...
        },
        {
            ...
            "answers": {
                "A": "apply 100% oxygen via a nonrebreathing mask.",
                "B": "place her supine and elevate her lower extremities.",
                "C": "perform a rapid head-to-toe physical assessment.",
                "D": "provide ventilation assistance with a bag valve mask."
            },
            "correctAnswer": "D"
        },
        {
            "question": "While jogging, a 19-year-old male experienced an acute onset of shortness of breath and pleuritic chest pain. He is conscious and alert with stable vital signs. Your assessment reveals that he has diminished breath sounds over the left side of the chest. You should:",
            "answers": {
        ...
        {
            "question": "You are transporting a stable patient with a possible pneumothorax. The patient is receiving high-flow oxygen and has an oxygen saturation of 95%. During your reassessment, you find that the patient is now confused, hypotensive, and profusely diaphoretic. What is most likely causing this patient’s deterioration?",
            "answers": {
                "A": "Compression of the aorta and vena cava",
                "B": "Hidden bleeding in the thoracic cavity",
                "C": "A total collapse of the affected lung",
                "D": "Blood accumulation in the pleural space"
            },
            "correctAnswer": "A"
        },
        {
            "question": "You arrive at the scene of a major motor vehicle crash. The patient, a 50-year-old female, was removed from her vehicle prior to your arrival. Bystanders who removed her state that she was not wearing a seatbelt. The patient is unresponsive, tachycardic, and diaphoretic. Your assessment reveals bilaterally clear and equal breath sounds, a midline trachea, and collapsed jugular veins. You should be most suspicious that this patient has experienced a:",
            "answers": {
        ...
        {
            "question": "You have sealed the open chest wound of a 40-year-old male who was stabbed in the anterior chest. Your reassessment reveals that he is experiencing increasing respiratory distress and tachycardia, and is developing cyanosis. You should:",
            "answers": {
                "A": "call for a paramedic ambulance.",
                "B": "partially remove the dressing.",
                "C": "begin ventilatory assistance.",
                "D": "begin rapid transport at once."
            },
            "correctAnswer": "B"
        },
        {
            "question": "A flail chest occurs when:",
            "answers": {
        ...
        {
            "question": "A patient who presents with profound cyanosis following a chest injury:",
            "answers": {
        ...
        {
            "question": "A rapid, irregular pulse following blunt trauma to the chest is most suggestive of a:",
            "answers": {
        ...
        {
            "question": "An open pneumothorax is:",
            "answers": {
        ...
        {
            "question": "Hemoptysis is defined as:",
            "answers": {
        ...
        },
        {
            ...
            "answers": {
                "A": "blood collection within the pleural space.",
                "B": "blood collection within the lung tissue.",
                "C": "accumulation of air in the pleural space.",
                "D": "accumulation of air between the lungs."
            },
            "correctAnswer": "C"
        },
        {
            "question": "Subcutaneous emphysema is an indication that:",
            "answers": {
                ...
                "D": "your patient is experiencing a pericardial tamponade."
            },
            "correctAnswer": "B"
        },
        {
            "question": "The ________ nerves supply the diaphragm.",
            "answers": {
                "A": "costal",
                "B": "intercostal",
                "C": "phrenic",
        ...
        {
            "question": "The phrenic nerves control the diaphragm and exit the spinal cord at:",
            "answers": {
                "A": "C3 and C4.",
                "B": "C3, C4, and C5.",
                "C": "C1 and C2.",
        ...
        {
            "question": "A patient who has experienced a back injury, with or without spinal cord damage, would be triaged with a __________ tag during a mass-casualty incident.",
            "answers": {
                "A": "green",
                "B": "yellow",
                "C": "red",
        ...
        {
            "question": "According to the START triage system, what should you do if you encounter an unresponsive patient who is not breathing?",
            "answers": {
        ...
        {
            "question": "Historically, the weak point at most major incidents has been:",
            "answers": {
                "A": "incident briefing.",
                "B": "communication.",
                "C": "accountability.",
        ...
        {
            "question": "Interoperability, an important feature of the NIMS, refers to the ability of:",
            "answers": {
                ...
                "D": "EMS systems and fire departments in the same jurisdiction to effectively work as a team."
            },
            "correctAnswer": "A"
        },
        {
            "question": "The __________ area is where incoming ambulances meet and await further instructions at the scene of a multiple-casualty incident.",
            "answers": {
                "A": "triage",
                "B": "transportation",
                "C": "staging",
        ...
        {
            "question": "The purpose of the incident command system (ICS) is to:",
            "answers": {
                "A": "protect the public from the effects of large- and small-scale disasters and to minimize the financial impact from such incidents.",
                "B": "quickly and efficiently respond to natural disasters and terrorist incidents, regardless of the complexity of the incident.",
        ...
        {
            "question": "Unlike a multiple-casualty incident, a natural disaster:",
            "answers": {
                ...
                "D": "exists when there are more than 100 critically injured patients."
            },
            "correctAnswer": "C"
        },
        {
            "question": "Which of the following patients should be assigned an immediate (red tag) category?",
            "answers": {
                "A": "36-year-old female with an open head injury, agonal breathing, and a slow pulse rate",
                "B": "31-year-old male with an open fracture of the forearm and minimal external bleeding",
                "C": "22-year-old male with blunt abdominal trauma, tachycardia, pallor, and diaphoresis",
                "D": "29-year-old female with a back injury and numbness and tingling in her extremities"
            },
            "correctAnswer": "C"
        },
        {
            "question": "A 49-year-old man has been removed from his overturned tanker, which was carrying a hazardous material. The tank ruptured, and he was exposed to the material. When rescue personnel bring him to the decontamination area, they note that he is unconscious and has slow, shallow breathing. They should:",
            "answers": {
        ...
        {
            "question": "According to the JumpSTART triage system, if a pediatric patient has a respiratory rate of 40 breaths/min, you should:",
            "answers": {
                "A": "assign an immediate category.",
                "B": "assess for a distal pulse.",
                "C": "look for posturing.",
                "D": "assess neurologic status."
            },
            "correctAnswer": "B"
        },
        {
            "question": "According to the JumpSTART triage system, infants or children not developed enough to walk or follow commands, including children with special needs:",
            "answers": {
                "A": "should be taken to the treatment area for immediate secondary triage.",
                "B": "are treated immediately in the primary triage area and then transported.",
                "C": "are initially triaged on the basis of whether they have distal pulses.",
                "D": "are the first to be transported, regardless of the severity of their injuries."
            },
            "correctAnswer": "A"
        },
        {
            "question": "According to the START triage system, which of the following patients should be triaged as an immediate priority (red tag)?",
            "answers": {
                "A": "Conscious, in severe pain, with radial pulses present",
                "B": "Apneic, despite manually opening the airway",
        ...
        {
            "question": "As the first-arriving senior EMT at the scene of an incident, you should perform a scene size-up and then:",
            "answers": {
                "A": "establish command.",
        ...
        {
            "question": "Coordination of balance and body movement is controlled by the:",
            "answers": {
                "A": "medulla.",
                "B": "brain stem.",
                "C": "cerebrum.",
        ...
        {
            "question": "In contrast to a cerebral concussion, a cerebral contusion:",
            "answers": {
                ...
                "D": "does not cause pressure within the skull."
            },
            "correctAnswer": "A"
        },
        {
        ...
        {
            "question": "The hormone responsible for the actions of the sympathetic nervous system is:",
            "answers": {
                "A": "epinephrine.",
                "B": "thyroxine.",
                "C": "aldosterone.",
        ...
        {
            "question": "Which of the following interventions may be used to help reduce intracranial pressure?",
            "answers": {
        ...
        {
            "question": "You should be most suspicious that a patient has experienced a significant head injury if his or her pulse is:",
            "answers": {
                "A": "weak.",
                "B": "irregular.",
                "C": "rapid.",
  ...
  },
  {
    ...
    "questions": [
        {
            "question": "A sign of kidney damage after blunt trauma is:",
            "answers": {
                "A": "hematemesis.",
                "B": "hemoptysis.",
                "C": "hematochezia.",
        ...
        {
            "question": "A 20-year-old male was accidentally shot in the right upper abdominal quadrant with an arrow during an archery contest. Prior to your arrival, the patient removed the arrow. Your assessment reveals that he is conscious and alert with stable vital signs. The entrance wound is bleeding minimally and appears to be superficial. You should:",
            "answers": {
                "A": "assume that the arrow injured an internal organ.",
                "B": "clean the wound and apply a dry, sterile dressing.",
        ...
        {
            "question": "A football player was struck by another player in the right flank area just below the posterior rib cage. He complains of severe pain and point tenderness to the area. Your assessment reveals that there is a small amount of blood in his underwear. You should be most suspicious for:",
            "answers": {
                "A": "external genitalia injury.",
                "B": "blunt injury to the kidney.",
                "C": "a lacerated liver or spleen.",
                "D": "a ruptured urinary bladder."
            },
            "correctAnswer": "B"
        },
        {
            "question": "Which of the following statements regarding abdominal eviscerations is correct?",
            "answers": {
                "A": "The organs should be replaced carefully to avoid heat loss.",
                "B": "The protruding organs should be kept warm and moist.",
                "C": "Most eviscerations occur to the left upper quadrant.",
        ...
        },
        {
            ...
            "answers": {
                ...
                "D": "the period of time between exposure and illness."
            },
            "correctAnswer": "A"
        },
        {
        ...
        },
        {
            ...
            "answers": {
                "A": "two EMTs are exposed to the same agent after being decontaminated.",
                "B": "an EMT has direct contact with a chemical agent at a terrorist incident.",
                "C": "an EMT provides care to a victim after the victim has been decontaminated.",
                "D": "an EMT is exposed to a victim who has not yet been decontaminated."
            },
            "correctAnswer": "D"
        },
        {
            "question": "Most terrorist attacks are:",
            "answers": {
                "A": "covert.",
                "B": "nuclear attacks.",
                "C": "impulsive.",
        ...
        {
            "question": "The 1996 Summer Olympics bombing is an example of:",
            "answers": {
        ...
        {
            "question": "Unlike viruses and bacteria, neurotoxins:",
            "answers": {
        ...
        },
        {
            ...
            "answers": {
                ...
                "B": "become thick and spontaneously clot.",
        ...
        {
            "question": "Which of the following statements regarding a “dirty bomb” is correct?",
            "answers": {
        ...
        },
        {
            ...
            "answers": {
                "A": "Cutaneous anthrax has a 90% mortality rate.",
                "B": "There is presently no vaccine against anthrax.",
        ...
        },
        {
            ...
            "answers": {
                ...
                "D": "the United States has an effective early warning system to detect an incoming nuclear missile."
            },
            "correctAnswer": "A"
        },
        {
        ...
        {
            "question": "Exposure to _________ would most likely result in immediate respiratory distress.",
            "answers": {
                "A": "lewisite",
                "B": "tabun",
                "C": "chlorine",
        ...
        {
            "question": "Signs and symptoms of exposure to a nerve agent include:",
            "answers": {
                "A": "salivation, pinpoint pupils, and diarrhea.",
                "B": "dry mouth, dilated pupils, and headache.",
        ...
        {
            "question": "You are dispatched to the scene of a building explosion. Upon arrival, you see people frantically fleeing the building, screaming, “Everyone is passing out!” You should:",
            "answers": {
                "A": "carefully assess the situation and ensure your own safety.",
                "B": "notify dispatch and state that a terrorist attack has occurred.",
        ...
        {
            "question": "Accumulation of blood in the abdominal cavity will most likely cause:",
            "answers": {
                "A": "referred pain.",
                "B": "diffuse bruising.",
        ...
        {
            "question": "All of the following are hollow abdominal organs, except the:",
            "answers": {
                "A": "bladder.",
                "B": "spleen.",
                "C": "ureters.",
        ...
        {
            "question": "Because the depth of an open abdominal wound is often difficult to determine:",
            "answers": {
                "A": "the EMT must perform a thorough exam.",
                "B": "the abdomen must be vigorously palpated.",
                "C": "vital signs should be monitored frequently.",
                "D": "prompt transport to the hospital is essential."
            },
            "correctAnswer": "D"
        },
        {
            "question": "Bruising to the right upper quadrant of the abdomen after blunt trauma is most suggestive of injury to the:",
            "answers": {
                "A": "spleen.",
                "B": "stomach.",
                "C": "liver.",
        ...
        {
            "question": "Compression injuries to the abdomen that occur during a motor vehicle crash are typically the result of:",
            "answers": {
                "A": "airbag deployment.",
        ...
        {
            "question": "Difficulty breathing and a sunken appearance of the anterior abdominal wall is most indicative of a ruptured:",
            "answers": {
                "A": "aorta.",
                "B": "stomach.",
                "C": "spleen.",
        ...
        {
            "question": "When a hollow organ is punctured during a penetrating injury to the abdomen:",
            "answers": {
                "A": "it commonly protrudes through the injury site.",
        ...
        {
            "question": "When documenting a call involving a female patient who was sexually assaulted, the EMT should:",
            "answers": {
        ...
        {
            "question": "Which of the following organs is at most risk for injury as the result of a pelvic fracture?",
            "answers": {
                "A": "Liver or spleen",
                "B": "Urinary bladder",
                "C": "Pancreas",
        ...
        {
            "question": "Which of the following statements regarding abdominal trauma is correct?",
            "answers": {
  ...
  },
  {
    ...
    "questions": [
        {
            "question": "Each ovary produces an ovum in alternating months and releases it into the:",
            "answers": {
                "A": "vagina.",
                "B": "fallopian tube.",
                "C": "cervical os.",
        ...
        {
            "question": "Atrophy is a condition that occurs when:",
            "answers": {
        ...
        {
            "question": "Common signs and symptoms of a sprain include all of the following, except:",
            "answers": {
                "A": "deformity.",
                "B": "swelling.",
                "C": "ecchymosis.",
        ...
        {
            "question": "In which of the following situations should the EMT splint an injured limb in the position of deformity?",
            "answers": {
        ...
        {
            "question": "Skeletal muscle is attached to the bone by tough, ropelike fibrous structures called:",
            "answers": {
                "A": "ligaments.",
                "B": "tendons.",
                "C": "cartilage.",
        ...
        {
            "question": "The most commonly fractured bone(s) in the body is the:",
            "answers": {
                "A": "radius and ulna.",
                "B": "scapula.",
                "C": "clavicle.",
        ...
        {
            "question": "Traction splints primarily immobilize and secure fractures of the:",
            "answers": {
                "A": "hip.",
                "B": "femur.",
                "C": "humerus.",
        ...
        {
            "question": "When splinting a possible fracture of the foot, it is most important for the EMT to:",
            "answers": {
                "A": "apply a pneumatic splint.",
        ...
        {
            "question": "Which of the following fractures has the greatest potential for internal blood loss and shock?",
            "answers": {
                "A": "Femur",
                "B": "Humerus",
                "C": "Hip",
        ...
        {
            "question": "Which of the following statements regarding compartment syndrome is correct?",
            "answers": {
        ...
        {
            "question": "A construction worker’s arm was severed just above the elbow when a steel girder fell on it. The stump is covered with a blood-soaked towel. The patient’s skin is cool, clammy, and pale. The EMT should:",
            "answers": {
                "A": "remove the towel and inspect the wound.",
                "B": "wrap the severed arm in a sterile dressing.",
                "C": "administer high-flow oxygen to the patient.",
                "D": "apply a tourniquet just below the shoulder."
            },
            "correctAnswer": "D"
        },
        {
            "question": "During your assessment of a 29-year-old female with significant deformity to her left elbow, you are unable to palpate a radial pulse. Your transport time to the hospital is approximately 40 minutes. You should:",
            "answers": {
        ...
        },
        {
            ...
            "answers": {
                "A": "applying a traction splint to immobilize her femur.",
        ...
        {
            "question": "During your secondary assessment of a 30-year-old male who fell 25 feet, you note crepitus when palpating his pelvis. Your partner advises you that the patient’s blood pressure is 80/50 mm Hg, and his heart rate is 120 beats/min and weak. After completing your assessment, you should:",
            "answers": {
        ...
        {
            "question": "You and your partner are preparing to apply a traction splint to a patient’s deformed thigh. As you apply manual traction, the patient resists your efforts and states that the pain is getting worse. You should:",
            "answers": {
                "A": "assess distal pulses and continue pulling traction.",
                "B": "flex the knee and place a pillow under the thigh.",
        ...
        {
            "question": "An air embolism associated with diving occurs when:",
            "answers": {
        ...
        {
            "question": "Burns associated with lightning strikes are typically:",
            "answers": {
                "A": "full-thickness.",
                "B": "superficial.",
                "C": "partial-thickness.",
        ...
        {
            "question": "Common signs and symptoms of heat exhaustion include all of the following, except:",
            "answers": {
                "A": "dry tongue and thirst.",
                "B": "tachycardia.",
                "C": "nausea.",
                "D": "hot, dry skin."
            },
        ...
        {
            "question": "Covering a patient’s _________ will significantly minimize radiation heat loss.",
            "answers": {
                "A": "chest",
                "B": "head",
                "C": "abdomen",
        ...
        {
            "question": "Drowning is most accurately defined as:",
            "answers": {
        ...
        {
            "question": "The transfer of heat to circulating air, such as when cool air moves across the body’s surface, is called:",
            "answers": {
                "A": "radiation.",
                "B": "conduction.",
                "C": "evaporation.",
        ...
        {
            "question": "The two most efficient ways for the body to eliminate excess heat are:",
            "answers": {
                "A": "perspiration and tachycardia.",
                "B": "respiration and bradycardia.",
        ...
        {
            "question": "The venom of a black widow spider is toxic to the:",
            "answers": {
                "A": "renal system.",
        ...
        {
            "question": "To obtain the most accurate reading of a patient’s core body temperature, you should place a special hypothermia thermometer:",
            "answers": {
                "A": "into the patient’s rectum.",
                "B": "behind the patient’s knee.",
        ...
        {
            "question": "Which of the following is an early sign of pit viper envenomation?",
            "answers": {
                "A": "General weakness and diaphoresis",
                "B": "Local swelling and ecchymosis",
                "C": "Signs and symptoms of hypoperfusion",
                "D": "Syncope and bleeding at distal sites"
            },
            "correctAnswer": "B"
        },
        {
            "question": "A 20-year-old male was pulled from cold water by his friends. The length of his submersion is not known and was not witnessed. You perform a primary assessment and determine that the patient is apneic and has a slow, weak pulse. You should:",
            "answers": {
                "A": "apply high-flow oxygen via a nonrebreathing mask, immobilize his spine, keep him warm, and transport rapidly.",
                "B": "provide rescue breathing, remove his wet clothing, immobilize his entire spine, keep him warm, and transport carefully.",
                "C": "ventilate with a bag-valve mask, apply a rigid cervical collar, remove his wet clothing, and transport rapidly.",
                "D": "suction his airway for 30 seconds, provide rescue breathing, keep him warm, and transport at once."
            },
            "correctAnswer": "B"
        },
        {
            "question": "After being stung on the leg by a jellyfish, a man complains of severe pain to his leg, dizziness, and difficulty breathing. He has a red rash covering his trunk, and his blood pressure is 90/50 mm Hg. The EMT should:",
            "answers": {
                "A": "remove the stingers from his leg by scraping them with a stiff object.",
                "B": "begin transport and immerse his leg in hot water to help reduce pain.",
                "C": "apply warmth to the sting area and cover it with a dry sterile dressing.",
                "D": "administer oxygen and epinephrine and prepare for rapid transport."
            },
            "correctAnswer": "D"
        },
        {
            "question": "You and your partner are standing by at a large social event at a river resort when a frantic woman tells you that she found a young male floating face-down in the water. Nobody claims to have witnessed the event. After you and your partner enter the water and reach the patient, you should:",
            "answers": {
                "A": "begin ventilations with a barrier device.",
                "B": "open his airway with the jaw-thrust maneuver.",
                "C": "move him as a unit to a supine position.",
                "D": "immediately secure him to a longboard."
            },
            "correctAnswer": "C"
        },
        {
            "question": "You are assessing a 33-year-old male who complains of severe abdominal pain, weakness, and nausea. He tells you that he was gathering wood to build a fire when he felt a sudden, sharp pain on the back of his hand. Your assessment reveals that the patient’s abdomen is rigid and painful to palpation. You should suspect:",
            "answers": {
        ...
        {
            "question": "You are assessing a man with suspected hypothermia. The patient is conscious, alert, and actively shivering. His respiratory rate is increased, but his breathing is unlabored, and the pulse oximeter reads 72%. The pulse oximetry reading is most likely:",
            "answers": {
                "A": "a direct reflection of his increased respiratory rate.",
                "B": "accurate because he has signs of respiratory failure.",
        ...
        {
            "question": "General treatment for a woman with vaginal bleeding and shock following sexual assault includes all of the following, EXCEPT:",
            "answers": {
                "A": "refraining from placing any dressings into the vagina.",
                "B": "carefully removing any foreign bodies from the vagina.",
                "C": "treating external lacerations with sterile compresses.",
                "D": "supplemental oxygen and keeping the patient supine."
            },
            "correctAnswer": "B"
        },
        {
            "question": "In anticipation of receiving a fertilized ovum, the lining of the uterine wall:",
            "answers": {
                "A": "diverts blood flow to the vagina.",
        ...
        {
            "question": "It is common for young females who experience their first menstrual period to:",
            "answers": {
        ...
        {
            "question": "Potentially life-threatening consequences of pelvic inflammatory disease (PID) include:",
            "answers": {
                "A": "ovarian cysts and gonorrhea.",
                "B": "uterine rupture with severe bleeding.",
                "C": "bacterial vaginosis and chlamydia.",
                "D": "ovarian abscess and ectopic pregnancy."
            },
            "correctAnswer": "D"
        },
        {
            "question": "The physical examination of a sexual assault victim should be:",
            "answers": {
                "A": "performed in the presence of at least two police officers.",
                "B": "limited to a brief survey for life-threatening injuries.",
                "C": "deferred until the patient can be evaluated by a physician.",
                "D": "as detailed as possible so all injuries can be documented."
            },
            "correctAnswer": "B"
        },
        {
            "question": "When caring for a woman who is experiencing a gynecologic emergency, the EMT’s main focus should be to:",
            "answers": {
        ...
        {
            "question": "Whenever possible, a female sexual assault victim should be:",
            "answers": {
                "A": "asked to provide a brief description of the perpetrator.",
                "B": "encouraged to take a shower and change her clothes.",
                "C": "given the option of being treated by a female EMT.",
                "D": "thoroughly assessed, even if no signs of injury exist."
            },
            "correctAnswer": "C"
        },
        {
            "question": "Which of the following statements regarding rape is correct?",
            "answers": {
                "A": "Rape causes more physical than emotional harm.",
                "B": "Only a licensed physician can make a diagnosis of rape.",
                "C": "Rape is a legal term, not a medical diagnosis.",
                "D": "The EMT should try to determine if rape occurred."
            },
            "correctAnswer": "C"
        }
    ]
